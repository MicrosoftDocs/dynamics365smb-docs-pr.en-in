...
---
# <a name="add-clients-to-your-dashboard-in-d365acc_long"></a>Add clients to your dashboard in [!INCLUDE [d365acc_long](includes/d365acc_long_md.md)]
...
### <a name="get-invited-to-a-clients-d365fin_long"></a>Get invited to a client's [!INCLUDE [d365fin_long](includes/d365fin_long_md.md)]
