...
---
# <a name="setting-up-goods-and-service-tax"></a>Setting Up Goods and Service Tax

[!INCLUDE[vnext_preview](../../includes/vnext_preview.md)]

Business Central has included GST Feature to Indian Localisation.
...
## <a name="to-set-up-gst-rates"></a>To set up GST rates
...
## <a name="to-set-up-gst-registration-number"></a>To set up GST registration number
...
## <a name="to-set-up-gst-accounting-period"></a>To set up GST accounting period
...
## <a name="to-set-up-gst-states"></a>To set up GST states
...
## <a name="to-set-up-gst-groups"></a>To set up GST groups
...
## <a name="to-set-up-gst-posting-setup"></a>To set up GST posting setup
...
## <a name="to-set-up-gst-in-company-information"></a>To set up GST in company information
...
## <a name="to-set-up-gst-in-location"></a>To set up GST in location
...
## <a name="to-set-up-gst-in-general-ledger-setup"></a>To set up GST in general ledger setup
...
## <a name="to-set-up-gst-in-purchase-and-payable-setup"></a>To set up GST in purchase and payable setup
...
## <a name="to-set-up-gst-in-sales-and-receivable-setup"></a>To set up GST in sales and receivable setup
...
## <a name="to-set-up-gst-in-source-code-setup"></a>To set up GST in source code setup
...
## <a name="to-set-up-gst-in-masters"></a>To set up GST in masters
...
## <a name="to-set-up-gst-in-vendor"></a>To set up GST in vendor
...
## <a name="to-set-up-gst-in-vendor-order-address"></a>To set up GST in vendor order address
...
## <a name="to-set-up-gst-in-customer"></a>To set up GST in customer
...
## <a name="to-set-up-gst-in-customer-ship-to-addresses"></a>To set up GST in customer ship to addresses
...
## <a name="to-set-up-gst-in-service-cost"></a>To set up GST in service cost
...
## <a name="to-set-up-gst-in-bank-account"></a>To set up GST in bank account
