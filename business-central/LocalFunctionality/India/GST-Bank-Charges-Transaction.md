...
---
# <a name="gst-on-bank-charges-transaction"></a>GST on Bank Charges Transaction
...
### <a name="gst-calculation-on-bank-charges"></a>GST calculation on bank charges
...
### <a name="gst-on-bank-charges"></a>GST on bank charges
...
## <a name="deemed-value-calculation-for-gst-base-amount-in-foreign-exchange-transactions"></a>Deemed value calculation for GST base amount in foreign exchange transactions
...
### <a name="gst-calculation-on-bank-charges-for-bank-payment"></a>GST calculation on bank charges for bank payment
