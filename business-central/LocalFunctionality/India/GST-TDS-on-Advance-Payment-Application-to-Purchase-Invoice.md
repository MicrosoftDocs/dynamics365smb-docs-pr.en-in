...
---
# <a name="gst-and-tds-on-vendor-advance-payments"></a>GST and TDS on Vendor Advance Payments

[!INCLUDE[vnext_preview](../../includes/vnext_preview.md)]

Liability of paying GST and TDS arises at the time of advance payment to vendor.

### <a name="mandatory-fields-in-cash-or-bank-payment-voucher"></a>Mandatory fields in cash or bank payment voucher
...
### <a name="mandatory-fields-on-purchase-invoice"></a>Mandatory fields on purchase invoice
