...
> [!NOTE]  
> If bank statement lines relate to cheque ledger entries, you cannot use the matching functions. Instead, you must choose the **Apply Entries** action, then select the relevant cheque ledger entry to match the bank statement line with.
...
## <a name="to-create-missing-ledger-entries-to-match-bank-statement-lines-with"></a>To create missing ledger entries to match bank statement lines with
