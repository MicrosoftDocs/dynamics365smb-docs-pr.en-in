...
---
# <a name="modify-planning-suggestions-in-a-graphical-view"></a><span data-ttu-id="61c7f-104">Modify Planning Suggestions in a Graphical View</span><span class="sxs-lookup"><span data-stu-id="61c7f-104">Modify Planning Suggestions in a Graphical View</span></span>

<span data-ttu-id="61c7f-105">A typical planning activity is to change or add planning worksheet lines to modify the suggested supply orders before you commit them by running the **Carry out Action Message** function.</span><span class="sxs-lookup"><span data-stu-id="61c7f-105">A typical planning activity is to change or add planning worksheet lines to modify the suggested supply orders before you commit them by running the **Carry out Action Message** function.</span></span> <span data-ttu-id="61c7f-106">An alternative to doing this in the planning worksheet is to use a graphical view.</span><span class="sxs-lookup"><span data-stu-id="61c7f-106">An alternative to doing this in the planning worksheet is to use a graphical view.</span></span> <span data-ttu-id="61c7f-107">However, this is currently not supported in [!INCLUDE[prodshort](includes/prodshort.md)].</span><span class="sxs-lookup"><span data-stu-id="61c7f-107">However, this is currently not supported in [!INCLUDE[prodshort](includes/prodshort.md)].</span></span>  
...
## <a name="see-also"></a><span data-ttu-id="61c7f-108">See Also</span><span class="sxs-lookup"><span data-stu-id="61c7f-108">See Also</span></span>

[<span data-ttu-id="61c7f-109">Planning</span><span class="sxs-lookup"><span data-stu-id="61c7f-109">Planning</span></span>](production-planning.md)  
[<span data-ttu-id="61c7f-110">Setting Up Manufacturing</span><span class="sxs-lookup"><span data-stu-id="61c7f-110">Setting Up Manufacturing</span></span>](production-configure-production-processes.md)  
[<span data-ttu-id="61c7f-111">Manufacturing</span><span class="sxs-lookup"><span data-stu-id="61c7f-111">Manufacturing</span></span>](production-manage-manufacturing.md)  
[<span data-ttu-id="61c7f-112">Inventory</span><span class="sxs-lookup"><span data-stu-id="61c7f-112">Inventory</span></span>](inventory-manage-inventory.md)  
[<span data-ttu-id="61c7f-113">Purchasing</span><span class="sxs-lookup"><span data-stu-id="61c7f-113">Purchasing</span></span>](purchasing-manage-purchasing.md)  
[<span data-ttu-id="61c7f-114">Design Details: Supply Planning</span><span class="sxs-lookup"><span data-stu-id="61c7f-114">Design Details: Supply Planning</span></span>](design-details-supply-planning.md)  
[<span data-ttu-id="61c7f-115">Setup Best Practices: Supply Planning</span><span class="sxs-lookup"><span data-stu-id="61c7f-115">Setup Best Practices: Supply Planning</span></span>](setup-best-practices-supply-planning.md)  
<span data-ttu-id="61c7f-116">[Working with [!INCLUDE[d365fin](includes/d365fin_md.md)]](ui-work-product.md)</span><span class="sxs-lookup"><span data-stu-id="61c7f-116">[Working with [!INCLUDE[d365fin](includes/d365fin_md.md)]](ui-work-product.md)</span></span>
