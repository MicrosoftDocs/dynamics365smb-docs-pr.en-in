...
| **Recognised Costs Account** |The expense account that contains the recognised costs for the job. It is a debit expense account ordinarily. |
| **Recognised Sales Account** |The income account that contains the recognised income for the job. It is a credit income account ordinarily. |
