...
You can manually specify the value on the line or let the programme use values that are defined on the vendor card, item card, stockkeeping unit card or the item vendor catalogue.
