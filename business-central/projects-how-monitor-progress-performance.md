...
1. Choose the ![Lightbulb that opens the Tell Me feature](media/ui-search/search_small.png "Tell me what you want to do") icon, enter **Job Registers** , then choose the related link.
2. Select a relevant register, then choose **Job Ledger** action.
