...
3. Choose the **Get Source Documents** action. The **Source Documents** page opens.
    ...
    All released source document lines that fulfil the filter criteria are now inserted in **Warehouse Receipt** page from which you activated the filter function.  
...
### <a name="to-perform-an-over-receipt"></a>To perform an over-receipt
