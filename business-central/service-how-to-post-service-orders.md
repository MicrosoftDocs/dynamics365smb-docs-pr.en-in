...
> [!Tip]
> Before you post a service document, it's a good idea to use the **Test Report** action to check for any errors or missing information. If there are errors, you must correct the problem. You can print a new test report to verify the fix, and then post the document.
