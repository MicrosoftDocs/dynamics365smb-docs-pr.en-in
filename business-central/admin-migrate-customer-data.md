...
## <a name="to-import-configuration-packages"></a>To import configuration packages
...
5. Clear the **Include Field** check box for any field that you do not want to import, then choose the **Set Included** or the **Clear Included** action.  
