...
Warehouse functionality in [!INCLUDE[d365fin](includes/d365fin_md.md)] contains different levels of complexity, as defined by licence permissions in the offered granules. The level of complexity in a warehouse solution is largely defined by the bin setup on location cards, which in turn is licence-controlled so that access to bin setup fields is defined by the licence. In addition, the application objects in the licence govern which UI document to use for the supported warehouse activities.  
