...
3.  When the sales invoice is ready to be invoiced, choose the **Post and Send** action.  
     ...
     If the customer’s default sending profile is an **Electronic Document** , then it will be shown in the **Post and Send Confirmation** dialogue box and you just have to choose the **Yes** button to post and send the invoice electronically in the selected format.  
