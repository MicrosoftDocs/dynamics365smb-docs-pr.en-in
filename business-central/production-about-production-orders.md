...
If you forward flush the production order at the start of the job, the behaviour of the application is very similar to a manual consumption. The major difference is that consumption happens automatically.  
