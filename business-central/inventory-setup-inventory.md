...
|Set up multiple units of measurement for an item that you can use as alternate UOMs, for example on sales, purchasing or production transactions.|[Set Up Item Units of Measurement](inventory-how-setup-units-of-measure.md)|
