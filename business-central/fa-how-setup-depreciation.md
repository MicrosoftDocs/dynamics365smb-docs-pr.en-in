...
4. On the **Integration** FastTab, select the check box for each fixed asset activity with transactions that you want to post using the **Fixed Asset G/L Journal** page.
