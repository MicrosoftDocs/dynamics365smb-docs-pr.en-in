...
### <a name="to-create-a-regenerative-plan-to-fulfill-demand-at-location-blue"></a>To create a regenerative plan to fulfil demand at location BLUE  
...
## <a name="analyzing-the-planning-result"></a>Analysing the Planning Result  
 ...
 The planning line for item 1300, Chain Assy, suggests ten pieces. This deviates from the five pieces that we expect to need to fulfil the sales order. Proceed to view the order tracking entries.  
