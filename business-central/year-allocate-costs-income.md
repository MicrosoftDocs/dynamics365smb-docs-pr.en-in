...
10. After entering the allocations lines, choose **OK** to return to the **Recurring General Journal** page. The **Allocated Amt. (INR)** field is filled in and matches the **Amount** field.
11. Post the journal.
