...
3. Select a user to be a time sheet administrator, then select the **Time Sheet Admin.** check box.  
...
2. Select the resource for which you want to set up the ability to use time sheets, then select the **Use Time Sheet** check box.  
