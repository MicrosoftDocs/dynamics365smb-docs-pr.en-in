...
|Routine|Description|  
|-------------|---------------------------------------|  
|StartPosting|Initialises posting buffer TempGLEntryBuf, locks G/L Entry and VAT Entry tables and initialises Accounting Period, G/L Register and Exchange Rate. Should be called only once, then NextEntryNo is 0.|  
|ContinuePosting|Checks and posts unrealised VAT for previous transaction increment NextTransactionNo and prepares post of next line.|  
