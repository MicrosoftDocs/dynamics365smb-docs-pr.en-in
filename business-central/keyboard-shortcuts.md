...
Keyboard shortcuts aid accessibility and can make it easier and more efficient to navigate to different areas and elements on a page. They're supported by most web browsers, however, the behaviour may vary slightly.
...
|Ctrl+Click|Navigate during personalising or customising when the action is highlighted with an arrowhead. For more information, see [Personalise Your Workspace](ui-personalization-user.md).|  
