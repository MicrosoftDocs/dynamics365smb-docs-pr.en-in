...
## <a name="to-define-a-vat-statements"></a>To define a VAT statements
...
1. Choose **Preview** .
2. Enter a date filter to limit the statement to a specific period. For more information on how to customise the page to show the date filter, see [Searching, filtering and Sorting Data](ui-enter-criteria-filters.md).
