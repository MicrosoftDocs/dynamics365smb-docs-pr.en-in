...
This walkthrough introduces you to the project management features in jobs. Jobs are a way for you to schedule the usage of your company's resources and to keep track of the various costs associated with the resources on a specific project. Jobs involves the consumption of employee hours, machine hours, inventory items, and other types of usage that you may want to track as a job progresses.  
 ...
 This walkthrough covers the setup of a new job in addition to some common tasks such as handling fixed pricing, making payment by instalments, posting invoices from jobs and copying jobs.  
...
### <a name="making-payment-by-installment"></a>Making Payment by Instalment  
 When a large, expensive project lasts for a long period, the customer often makes an agreement with the company to pay by instalments. This scenario shows how you set up payment by instalments and covers:  

-   Creating payment by instalments for a job.  
-   Invoicing payments to customers.  
-   Accounting for usage in a job set up for payment by instalments.  
...
6.  On the **Foreign Trade** FastTab, set the currency code to **INR** . If you select INR in the **Invoice Currency Code** field, then the job will be invoiced in Indian Rupees and planned in the local currency of CRONUS only.  
...
5.  On the **Job Item Prices** page, enter the following information and customised price:  
    ...
    1.  **Item No.** : **80201 (Graphic Programme)**  
    2.  **Unit Price** : **200**  
