...
## <a name="story"></a>Story  
 ...
 Arnie registers the customer's payment and applies it to the invoices, then sends the final invoice.  
...
-   Phyllis sets the application to check if prepayments are required before final invoicing on an order.  
