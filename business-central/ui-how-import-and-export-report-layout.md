...
4.  In the **Export File** dialogue box, choose the **Save** button, then save the file to a location on your computer or network.  
...
5.  In the **Import** dialogue box, select the document that defines the report layout, then choose the **Open** button.  
