...
-   Generating an assembly order to fulfil a sales line quantity by the demanded shipment date.  
...
John brings the ten units of Kit A from the warehouse to the specified shipping area, records the quantity to handle, then registers the pick.  
...
4.  Choose the **Register** action, then choose the **Yes** button.  
...
14. Choose the **Post Shipment** action, and then select the **Ship** button.  
    ...
    Warehouse activities to fulfil the first sales order line by January 23 are completed. Next, fulfil the sales order lines that are shipping on January 27  
...
6.  Choose the **Autofill Qty. to Handle** action.  
7.  Choose the **Register Pick** action, then choose the **Yes** button.  
