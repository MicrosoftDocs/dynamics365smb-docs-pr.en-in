...
* **?** Allows any character.  
    ...
    > [!Tip]
    > You can use other characters as long as they are always present in the country or region format. For example, if you need to include a full stop or a hyphen between sets of numbers, you can define the format as ##.####.### or @@-###-###.  
...
## <a name="setting-up-clauses-to-explain-vat-exemption-or-non-standard-vat-rates"></a>Setting Up Clauses to Explain VAT Exemption or Non-Standard VAT Rates
