...
|Static allocation|Static allocations are based on a fixed set of values, for example, the square metres used or an established allocation ratio, such as 5:2:4.|  
