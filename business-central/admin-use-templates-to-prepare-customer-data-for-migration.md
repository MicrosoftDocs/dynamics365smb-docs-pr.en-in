...
## <a name="to-create-a-new-data-template"></a>To create a new data template
...
### <a name="to-copy-an-existing-data-template"></a>To copy an existing data template
...
### <a name="to-create-a-data-template-header-manually"></a>To create a data template header manually
...
### <a name="to-create-a-data-template-line-manually"></a>To create a data template line manually
...
## <a name="to-import-from-a-template-in-excel"></a>To import from a template in Excel
