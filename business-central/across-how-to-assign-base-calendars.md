...
When you make an entry, the **Nonworking** field is selected. You can choose to clear the cheque mark to make it a working day.  
...
2. Open the location that you want to update, then select the **Customised Calendar** field. Note that a calendar must be selected in the **Base Calendar Code** field.
