...
> Note that if you use the Bins or Zones functionality, then you cannot use physical inventory orders. In stead, use **Whse. Phys. Inventory Journal** page to count your warehouse entries before synchronising them with item ledger entries.
...
## <a name="handling-item-tracking-when-counting-inventory"></a>Handling Item Tracking when Counting Inventory
