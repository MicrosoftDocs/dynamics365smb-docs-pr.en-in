...
#### <a name="to-map-columns-in-the-data-file-to-fields-in-d365fin"></a>To map columns in the data file to fields in [!INCLUDE[d365fin](includes/d365fin_md.md)]  
> [!TIP]
...
```
After you define your rules you can test them. In the **Test** section, enter an example of a value that you want to transform, and then cheque the results.
