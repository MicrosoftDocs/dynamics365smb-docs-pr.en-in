...
1. Choose the ![Lightbulb that opens the Tell Me feature](media/ui-search/search_small.png "Tell me what you want to do") icon, enter **Catalogue Items** , then choose the related link.
...
1. Choose the ![Lightbulb that opens the Tell Me feature](media/ui-search/search_small.png "Tell me what you want to do") icon, enter **catalogue Item Setup** , then choose the related link.
...
4. Choose the **Line** action, then choose the **Select Catalogue Items** action.
...
5. On the **Catalogue Items** page, select the catalogue item that you want to sell, then choose the **OK** button.
